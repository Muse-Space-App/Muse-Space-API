...
public static class SeedData
{
    ...
    public static async Task SeedArtworksAsync(this MuseSpaceDbContext context)
    {
        ...
        {
            new { Title = "Golden Hour Over the Mountains", Desc = "Warm light spilling across a vast mountain landscape at sunset.", Url = "https://res.cloudinary.com/dzpv8dz7e/image/upload/v1780888547/rrxgc4xrzgk3rtnpcytz.jpg", Thumb = "https://res.cloudinary.com/dzpv8dz7e/image/upload/w_400,c_fill/v1780888547/rrxgc4xrzgk3rtnpcytz.jpg", UserIdx = 0, TagNames = new[] { "Landscape", "Photography" }, W = 1200, H = 800 },
            new { Title = "Neon City Reflections", Desc = "Rain-soaked streets reflecting vibrant neon lights of the city.", Url = "https://res.cloudinary.com/dzpv8dz7e/image/upload/v1780888548/murbqwu8vw5yrhdgxh8c.jpg", Thumb = "https://res.cloudinary.com/dzpv8dz7e/image/upload/w_400,c_fill/v1780888548/murbqwu8vw5yrhdgxh8c.jpg", UserIdx = 1, TagNames = new[] { "Photography", "Digital Art" }, W = 1200, H = 800 },
            new { Title = "Abstract Fluid Motion", Desc = "Swirling colors in a mesmerizing abstract composition.", Url = "https://res.cloudinary.com/dzpv8dz7e/image/upload/v1780888549/cjow5bfobtm3gz6jvfai.jpg", Thumb = "https://res.cloudinary.com/dzpv8dz7e/image/upload/w_400,c_fill/v1780888549/cjow5bfobtm3gz6jvfai.jpg", UserIdx = 2, TagNames = new[] { "Abstract", "Digital Art" }, W = 1200, H = 800 },
            new { Title = "Serene Japanese Garden", Desc = "A tranquil garden scene with cherry blossoms and still water.", Url = "https://res.cloudinary.com/dzpv8dz7e/image/upload/v1780888550/ep1nyxrlkopkeyrvf4ey.jpg", Thumb = "https://res.cloudinary.com/dzpv8dz7e/image/upload/w_400,c_fill/v1780888550/ep1nyxrlkopkeyrvf4ey.jpg", UserIdx = 0, TagNames = new[] { "Landscape", "Photography" }, W = 1200, H = 800 },
            ...
            new { Title = "Minimalist Still Life", Desc = "Clean, minimal composition with soft shadows and neutral tones.", Url = "https://res.cloudinary.com/dzpv8dz7e/image/upload/v1780888558/z9xezfxhudheucgalqti.jpg", Thumb = "https://res.cloudinary.com/dzpv8dz7e/image/upload/w_400,c_fill/v1780888558/z9xezfxhudheucgalqti.jpg", UserIdx = 2, TagNames = new[] { "Photography", "Abstract" }, W = 1200, H = 800 },
        };

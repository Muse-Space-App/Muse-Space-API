...
public static class SeedData
{
    ...
    public static async Task SeedArtworksAsync(this MuseSpaceDbContext context)
    {
        ...
        {
            new { Title = "Golden Hour Over the Mountains", Desc = "Warm light spilling across a vast mountain landscape at sunset.", Url = "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=1200", Thumb = "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=400", UserIdx = 0, TagNames = new[] { "Landscape", "Photography" }, W = 1200, H = 800 },
            ...
            new { Title = "Abstract Fluid Motion", Desc = "Swirling colors in a mesmerizing abstract composition.", Url = "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=1200", Thumb = "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=400", UserIdx = 2, TagNames = new[] { "Abstract", "Digital Art" }, W = 1200, H = 800 },
            new { Title = "Serene Japanese Garden", Desc = "A tranquil garden scene with cherry blossoms and still water.", Url = "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=1200", Thumb = "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=400", UserIdx = 0, TagNames = new[] { "Landscape", "Photography" }, W = 1200, H = 800 },
            new { Title = "Portrait in Natural Light", Desc = "Soft natural light creating a warm, intimate portrait.", Url = "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=1200", Thumb = "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400", UserIdx = 1, TagNames = new[] { "Portrait", "Photography" }, W = 1200, H = 900 },
            ...
            new { Title = "Vintage Film Tones", Desc = "A nostalgic scene captured with warm vintage film aesthetics.", Url = "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=1200", Thumb = "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=400", UserIdx = 0, TagNames = new[] { "Photography", "Illustration" }, W = 1200, H = 800 },
            ...
            new { Title = "Urban Architecture Lines", Desc = "Bold geometric patterns found in modern urban architecture.", Url = "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1200", Thumb = "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=400", UserIdx = 2, TagNames = new[] { "Photography", "Abstract" }, W = 1200, H = 800 },
            new { Title = "Ocean Depths", Desc = "Mysterious deep blue ocean waves crashing against rocks.", Url = "https://images.unsplash.com/photo-1505118380757-91f5f5632de0?w=1200", Thumb = "https://images.unsplash.com/photo-1505118380757-91f5f5632de0?w=400", UserIdx = 0, TagNames = new[] { "Landscape", "Photography" }, W = 1200, H = 800 },
            new { Title = "Digital Character Sketch", Desc = "A striking character design concept with bold color choices.", Url = "https://images.unsplash.com/photo-1580582932707-520aed937b7b?w=1200", Thumb = "https://images.unsplash.com/photo-1580582932707-520aed937b7b?w=400", UserIdx = 1, TagNames = new[] { "Character Design", "Digital Art" }, W = 1200, H = 900 },
            new { Title = "Minimalist Still Life", Desc = "Clean, minimal composition with soft shadows and neutral tones.", Url = "https://images.unsplash.com/photo-1481277542470-605612bd2d61?w=1200", Thumb = "https://images.unsplash.com/photo-1481277542470-605612bd2d61?w=400", UserIdx = 2, TagNames = new[] { "Photography", "Abstract" }, W = 1200, H = 800 },
            new { Title = "Misty Forest Morning", Desc = "Fog rolling through ancient pine trees at dawn.", Url = "https://images.unsplash.com/photo-1448375240586-882707db888b?w=1200", Thumb = "https://images.unsplash.com/photo-1448375240586-882707db888b?w=400", UserIdx = 0, TagNames = new[] { "Landscape", "Photography" }, W = 1200, H = 800 },
            new { Title = "Cyberpunk Alley", Desc = "A futuristic alleyway glowing with holograms.", Url = "https://images.unsplash.com/photo-1605810230434-7631ac76ec81?w=1200", Thumb = "https://images.unsplash.com/photo-1605810230434-7631ac76ec81?w=400", UserIdx = 1, TagNames = new[] { "Digital Art", "Concept Art" }, W = 1200, H = 1600 },
            new { Title = "Abstract Geometric", Desc = "Sharp angles and vibrant colors intersecting.", Url = "https://images.unsplash.com/photo-1557672172-298e090bd0f1?w=1200", Thumb = "https://images.unsplash.com/photo-1557672172-298e090bd0f1?w=400", UserIdx = 2, TagNames = new[] { "Abstract", "3D Art" }, W = 1200, H = 1200 },
            new { Title = "Sunset Over the City", Desc = "The city skyline silhouetted against a brilliant orange sky.", Url = "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=1200", Thumb = "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=400", UserIdx = 0, TagNames = new[] { "Photography", "Landscape" }, W = 1600, H = 900 },
            new { Title = "Enchanted Forest", Desc = "A magical woodland with glowing flora.", Url = "https://images.unsplash.com/photo-1511497584788-876760111969?w=1200", Thumb = "https://images.unsplash.com/photo-1511497584788-876760111969?w=400", UserIdx = 1, TagNames = new[] { "Concept Art", "Digital Art" }, W = 1200, H = 1600 },
            new { Title = "Macro Water Drops", Desc = "Extreme close up of dew drops on a spider web.", Url = "https://images.unsplash.com/photo-1518802508264-76256089cddb?w=1200", Thumb = "https://images.unsplash.com/photo-1518802508264-76256089cddb?w=400", UserIdx = 2, TagNames = new[] { "Photography", "Abstract" }, W = 1200, H = 800 },
            new { Title = "Steampunk Airship", Desc = "A brass and leather airship cruising through the clouds.", Url = "https://images.unsplash.com/photo-1534067783941-51c9c23ecefd?w=1200", Thumb = "https://images.unsplash.com/photo-1534067783941-51c9c23ecefd?w=400", UserIdx = 0, TagNames = new[] { "Concept Art", "Digital Art" }, W = 1600, H = 1200 },
            new { Title = "Vibrant Street Art", Desc = "Colorful graffiti adorning an urban wall.", Url = "https://images.unsplash.com/photo-1499781350541-7783f6c6a0c8?w=1200", Thumb = "https://images.unsplash.com/photo-1499781350541-7783f6c6a0c8?w=400", UserIdx = 1, TagNames = new[] { "Photography", "Traditional Art" }, W = 1200, H = 800 },
            new { Title = "Cosmic Eye", Desc = "A surreal depiction of an eye forming a galaxy.", Url = "https://images.unsplash.com/photo-1543722530-d2c3201371e7?w=1200", Thumb = "https://images.unsplash.com/photo-1543722530-d2c3201371e7?w=400", UserIdx = 2, TagNames = new[] { "Digital Art", "Abstract" }, W = 1200, H = 1200 },
            new { Title = "Desert Dunes", Desc = "Rolling sand dunes under a harsh midday sun.", Url = "https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=1200", Thumb = "https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=400", UserIdx = 0, TagNames = new[] { "Photography", "Landscape" }, W = 1600, H = 900 },
            new { Title = "Mecha Warrior", Desc = "A highly detailed giant robot standing ready for battle.", Url = "https://images.unsplash.com/photo-1614729939124-032f0b56c9ce?w=1200", Thumb = "https://images.unsplash.com/photo-1614729939124-032f0b56c9ce?w=400", UserIdx = 1, TagNames = new[] { "Character Design", "3D Art" }, W = 1200, H = 1600 },
            new { Title = "Fluid Colors", Desc = "Macro photography of oil and water mixed with ink.", Url = "https://images.unsplash.com/photo-1558470598-a5dda9640f68?w=1200", Thumb = "https://images.unsplash.com/photo-1558470598-a5dda9640f68?w=400", UserIdx = 2, TagNames = new[] { "Photography", "Abstract" }, W = 1200, H = 800 },
            new { Title = "Cozy Cafe", Desc = "A warm, inviting coffee shop interior.", Url = "https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=1200", Thumb = "https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=400", UserIdx = 0, TagNames = new[] { "Photography", "Illustration" }, W = 1600, H = 1200 },
            new { Title = "Neon Tokyo", Desc = "A stunning cyberpunk street view in neon colors.", Url = "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=1200", Thumb = "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=400", UserIdx = 1, TagNames = new[] { "Photography", "Digital Art" }, W = 1200, H = 1600 },
            new { Title = "Minimalist Architecture", Desc = "Clean lines and shadows on a modern building.", Url = "https://images.unsplash.com/photo-1513694203232-719a280e022f?w=1200", Thumb = "https://images.unsplash.com/photo-1513694203232-719a280e022f?w=400", UserIdx = 2, TagNames = new[] { "Photography", "Abstract" }, W = 1600, H = 1200 },
            new { Title = "Galactic Dust", Desc = "A swirl of cosmic dust and stars in deep space.", Url = "https://images.unsplash.com/photo-1502134249126-9f3755a50d78?w=1200", Thumb = "https://images.unsplash.com/photo-1502134249126-9f3755a50d78?w=400", UserIdx = 0, TagNames = new[] { "Digital Art", "Abstract" }, W = 1200, H = 800 },
            new { Title = "Autumn Leaves", Desc = "Vibrant fall colors in a serene forest.", Url = "https://images.unsplash.com/photo-1507371341162-763b5e419408?w=1200", Thumb = "https://images.unsplash.com/photo-1507371341162-763b5e419408?w=400", UserIdx = 1, TagNames = new[] { "Photography", "Landscape" }, W = 1200, H = 800 },
            new { Title = "Cybernetic Eye", Desc = "A close up of a futuristic bionic eye.", Url = "https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200", Thumb = "https://images.unsplash.com/photo-1518770660439-4636190af475?w=400", UserIdx = 2, TagNames = new[] { "Digital Art", "Concept Art" }, W = 1600, H = 1200 },
            new { Title = "Snowy Peaks", Desc = "Majestic snow-capped mountains under a clear sky.", Url = "https://images.unsplash.com/photo-1454496522488-7a8e488e8606?w=1200", Thumb = "https://images.unsplash.com/photo-1454496522488-7a8e488e8606?w=400", UserIdx = 0, TagNames = new[] { "Photography", "Landscape" }, W = 1200, H = 800 },
            new { Title = "Ink Wash Landscape", Desc = "A traditional ink wash painting of a valley.", Url = "https://images.unsplash.com/photo-1563241527-3004b7be0ffd?w=1200", Thumb = "https://images.unsplash.com/photo-1563241527-3004b7be0ffd?w=400", UserIdx = 1, TagNames = new[] { "Traditional Art", "Landscape" }, W = 1200, H = 800 },
            new { Title = "Holographic Projection", Desc = "A glowing 3D hologram in a dark room.", Url = "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1200", Thumb = "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=400", UserIdx = 2, TagNames = new[] { "3D Art", "Concept Art" }, W = 1600, H = 1200 },
            new { Title = "Rain on Glass", Desc = "Water droplets reflecting the city lights.", Url = "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?w=1200", Thumb = "https://images.unsplash.com/photo-1515694346937-94d85e41e6f0?w=400", UserIdx = 0, TagNames = new[] { "Photography", "Abstract" }, W = 1200, H = 1600 },
            new { Title = "Fantasy Castle", Desc = "A towering castle floating in the clouds.", Url = "https://images.unsplash.com/photo-1519074069444-1ba4fff66d16?w=1200", Thumb = "https://images.unsplash.com/photo-1519074069444-1ba4fff66d16?w=400", UserIdx = 1, TagNames = new[] { "Concept Art", "Digital Art" }, W = 1600, H = 1200 },
            new { Title = "Retro Grid", Desc = "An 80s outrun style wireframe grid.", Url = "https://images.unsplash.com/photo-1614730321146-b6fa6a46bcb4?w=1200", Thumb = "https://images.unsplash.com/photo-1614730321146-b6fa6a46bcb4?w=400", UserIdx = 2, TagNames = new[] { "Digital Art", "Abstract" }, W = 1200, H = 800 },
            new { Title = "Cherry Blossom Path", Desc = "A serene walkway lined with blooming Sakura trees.", Url = "https://images.unsplash.com/photo-1522383225653-ed111181a951?w=1200", Thumb = "https://images.unsplash.com/photo-1522383225653-ed111181a951?w=400", UserIdx = 0, TagNames = new[] { "Photography", "Landscape" }, W = 1600, H = 1200 },
            new { Title = "Mecha Pilot", Desc = "A character design for a sci-fi pilot suit.", Url = "https://images.unsplash.com/photo-1535295972055-1c762f4483e5?w=1200", Thumb = "https://images.unsplash.com/photo-1535295972055-1c762f4483e5?w=400", UserIdx = 1, TagNames = new[] { "Character Design", "Concept Art" }, W = 1200, H = 1600 },
            new { Title = "Abstract Ink", Desc = "A burst of blue and purple ink underwater.", Url = "https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=1200", Thumb = "https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=400", UserIdx = 2, TagNames = new[] { "Photography", "Abstract" }, W = 1200, H = 800 }
        };

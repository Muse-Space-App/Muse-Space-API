...
public interface IGroupService
{
    ...
    Task<GenericResult<GroupResponse>> GetGroupAsync(int groupId, int? currentUserId = null, CancellationToken cancellationToken = default);
    ...
    Task<GenericResult<PagedResult<GroupResponse>>> GetAllGroupsAsync(int page, int pageSize, int? currentUserId = null, CancellationToken cancellationToken = default);
